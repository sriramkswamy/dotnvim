...
nnoremap <silent> <leader>gk :StartJob gitk<cr>
nnoremap <silent> <leader>gg :tabe<CR>:terminal tig status<cr>

vnoremap <silent> vu :Git blame<cr>
vnoremap <silent> yu <Esc>:let @s = getpos("'\<")[1] . "," . getpos("'\>")[1]<cr>:<C-U>Git! log -100 -L <C-R>s:%<CR>
vnoremap <silent> yU <Esc>:let @s = getpos("'\<")[1] . "," . getpos("'\>")[1]<cr>:<C-U>Git! log -100 -L <C-R>s:%<CR>
vnoremap <silent> <leader>gk :StartJob gitk<cr>
vnoremap <silent> <leader>gg :terminal tig status<cr>
