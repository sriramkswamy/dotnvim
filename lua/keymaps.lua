...
vim.keymap.set('n', '[a', '<cmd>previous<CR>', { silent = true, desc = 'previous file' })
vim.keymap.set('n', ']a', '<cmd>next<CR>', { silent = true, desc = 'next file' })
vim.keymap.set('n', '[A', '<cmd>first<CR>', { silent = true, desc = 'first file' })
vim.keymap.set('n', ']A', '<cmd>last<CR>', { silent = true, desc = 'last file' })
vim.keymap.set('n', '[t', '<cmd>tprevious<CR>', { silent = true, desc = 'previous tag' })
vim.keymap.set('n', ']t', '<cmd>tnext<CR>', { silent = true, desc = 'next tag' })
vim.keymap.set('n', '[T', '<cmd>tfirst<CR>', { silent = true, desc = 'first tag' })
vim.keymap.set('n', ']T', '<cmd>tlast<CR>', { silent = true, desc = 'last tag' })
vim.keymap.set('n', '[n', '<cmd>?^<\\+\\s*HEAD$<CR>', { silent = true, desc = 'previous git conflict' })
vim.keymap.set('n', ']n', '<cmd>/^<\\+\\s*HEAD$<CR>', { silent = true, desc = 'next git conflict' })
vim.keymap.set('n', '[N', '<cmd>?^<\\+<$<CR>', { silent = true, desc = 'previous git merge' })
vim.keymap.set('n', ']N', '<cmd>/^<\\+<$<CR>', { silent = true, desc = 'next git merge' })
