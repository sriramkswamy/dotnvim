return {
    ...
    config = function ()
      ...
      require('mini.clue').setup({
        triggers = {
          ...
          { mode = 'n', keys = '<leader>y' },
          { mode = 'x', keys = '<leader>y' },
  ...
  { -- useful all-in-one utilities
    ...
    keys = {
      ...
      { "<leader>fi", mode = {"n", "x"}, function() Snacks.picker.lsp_incoming_calls() end, desc = "LSP Incoming Calls"},
      { "<leader>fl", function() Snacks.picker.loclist() end, desc = "Location List"},
      { "<leader>fm", function() Snacks.picker.qflist() end, desc = "Quickfix List"},
      { "<leader>fo", mode = {"n", "x"}, function() Snacks.picker.lsp_outgoing_calls() end, desc = "LSP Outgoing Calls"},
      { "<leader>gd", function() Snacks.git.blame_line() end, desc = "Git Last Change"},
