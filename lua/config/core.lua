return {
  ...
  { -- useful all-in-one utilities
    ...
    keys = {
      ...
      { "<leader>c", function() Snacks.picker.jumps() end, desc = "Jump List"},
      { "<leader>d", function() Snacks.picker.lsp_workspace_symbols() end, desc = "LSP Workspace Symbols"},
      ...
      { "<leader>y", function() Snacks.picker.recent() end, desc = "Recent Files"},
